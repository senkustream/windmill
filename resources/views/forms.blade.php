...
<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
    <label class="block text-sm">
        ...
        <div class="relative">
            <input class="block rounded w-full pl-20 mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:ring focus:ring-purple-400 dark:focus:outline-none dark:focus:ring dark:focus:ring-gray-100 form-input"
    ...
    <label class="block mt-4 text-sm">
        ...
        <div class="relative text-gray-500 focus-within:text-purple-600">
            <input class="block rounded w-full pr-20 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:ring focus:ring-purple-400 dark:focus:outline-none dark:focus:ring dark:focus:ring-gray-100 form-input"
                placeholder="Jane Doe"/>
